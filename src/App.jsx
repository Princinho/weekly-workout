...
const DAYS = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        sets: 3, reps: "8–12",
        videos: ["https://www.youtube.com/shorts/k6tzKisR3NY", "https://youtu.be/qEwKCR5JCog"],
      ...
      },
      {
        ...
        equipment: "2×10kg · bench",
        sets: 4, reps: "8–12",
        videos: ["https://www.youtube.com/shorts/oNsqMW1gPiU", "https://youtube.com/shorts/4v59ShSjX2w"],
      ...
      },
      {
        ...
        videos: ["https://www.youtube.com/shorts/Kl3LEzQ5Zqs", "https://www.youtube.com/shorts/Bcr6WBc2WKc", "https://youtube.com/shorts/Fr-T6grtBHw"],
        how: "Stand next to a wall or hold a sturdy upright. Lean away from it, holding one dumbbell in your free hand. Raise that arm out to the side to shoulder height, pause, lower slowly.",
        gotchas: [
      ...
      },
      {
        ...
        equipment: "1×10kg",
        sets: 3, reps: "10–15",
        videos: ["https://youtube.com/shorts/b_r_LW4HEcM", "https://youtube.com/shorts/AYqg9S5FrUU"],
    ...
    exercises: [
      {
        ...
        videos: ["https://youtube.com/shorts/or1frhkjBDc", "https://youtube.com/shorts/tdOk9XkzGVc", "https://youtube.com/shorts/kexMyz2z6WU"],
      ...
      },
      {
        ...
        equipment: "2×10kg",
        sets: 3, reps: "10–15",
        videos: ["https://youtube.com/shorts/hu3jRvTc_po", "https://youtube.com/shorts/Wou9zVQrAfs"],
      ...
      },
      {
        ...
        equipment: "1×10kg",
        sets: 3, reps: "10–15",
        videos: ["https://youtube.com/shorts/UPeQpDPRWOg"],
      ...
      },
      {
        ...
        equipment: "1×10kg",
        sets: 3, reps: "8–12 per side",
        videos: ["https://youtube.com/shorts/wdOkFomQNp8", "https://youtube.com/shorts/sNqa1ad2qIQ"],
      ...
      },
      {
        ...
        sets: 5, reps: "10 reps",
        videos: ["https://youtube.com/shorts/5qah1cTaJCk", "https://youtube.com/shorts/Aoipu_fl3HA"],
        how: "Lie on your back, arms pointing straight up at the ceiling, knees bent at 90° in the air. Slowly lower your right arm behind your head AND your left leg toward the floor simultaneously — without letting your lower back lift off the floor. Bring them back, then switch sides.",
        gotchas: [
    ...
    exercises: [
      {
        ...
        sets: 4, reps: "8–12",
        videos: ["https://youtu.be/SylLLJVhR78", "https://youtu.be/NamiVqVgPTU"],
        how: "Lie on your back on the floor. Hold the barbell with hands slightly wider than shoulder-width. Start with arms extended. Lower the bar until your upper arms (triceps) rest on the floor, pause for a beat, then press back up.",
        gotchas: [
      ...
      },
      {
        ...
        videos: ["https://youtube.com/shorts/yHqqGd0tXcw", "https://youtube.com/shorts/PilFW4QEFwc"],
      ...
      },
      {
        ...
        equipment: "2×10kg",
        sets: 3, reps: "10–20",
        videos: ["https://www.youtube.com/shorts/Kl3LEzQ5Zqs", "https://youtube.com/shorts/Fr-T6grtBHw"],
      ...
      },
      {
        ...
        equipment: "1×10kg",
        sets: 3, reps: "10–15",
        videos: ["https://youtube.com/shorts/AYqg9S5FrUU", "https://youtube.com/shorts/n-opc-Ap034"],
        how: "Stand upright. Hold one dumbbell with both hands overhead (grip the top weight plate). Upper arms stay glued vertically next to your head. Bend elbows to lower the dumbbell behind your head, then press back up.",
        gotchas: [
    ...
    exercises: [
      {
        ...
        sets: 4, reps: "8–12 per side",
        videos: ["https://youtube.com/shorts/or1frhkjBDc", "https://youtube.com/shorts/tdOk9XkzGVc", "https://youtube.com/shorts/kexMyz2z6WU"],
        how: "Same setup as Tuesday — rear foot on bench, dumbbell in each hand. Lean your torso slightly forward and take a wider step forward. This shifts the load from quads to glutes. Lower your back knee toward the floor, then drive up.",
        gotchas: [
          ...
          "Same balance warning as Tuesday — go slow",
        ],
      },
      {
        ...
        equipment: "1×10kg · bench",
        sets: 3, reps: "10–20 per side",
        videos: ["https://youtube.com/shorts/3suM3LwVlVM", "https://youtube.com/shorts/96uDbymTaHM"],
      ...
      },
      {
        ...
        equipment: "1×10kg",
        sets: 3, reps: "8–12 per side",
        videos: ["https://youtube.com/shorts/baEXLy09Ncc", "https://youtube.com/shorts/wdOkFomQNp8"],
      ...
      },
      {
        ...
        sets: 3, reps: "10–20",
        videos: ["https://youtube.com/shorts/lLUniqm00KM", "https://youtube.com/shorts/hDZFKJT6nvM"],
      ...
      },
      {
        ...
        sets: 3, reps: "10–20",
        videos: ["https://youtube.com/shorts/ZyE4r7wiI6w", "https://youtube.com/shorts/I-qRngqd2wY"],
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      <div style={{
        ...
        fontFamily: "'Inconsolata', monospace", fontWeight: 600, marginBottom: 8,
      }}>▶ VIDEO REFERENCE</div>
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        ...
        {/* Thumbnail strip (vertical, right side for shorts; below for regular) */}
        {ids.length > 1 && (
          <div style={{
            display: "flex",
            ...
            {ids.map((id, i) => (
              ...
              >
                <img
                  ...
                  alt={`Video ${i + 1}`}
                  style={{ width: isShort ? 64 : 72, height: isShort ? 42 : 48, objectFit: "cover", display: "block" }}
                />
              </button>
            ))}
          </div>
...
export default function BWS() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f7f4ef", fontFamily: "'Syne', sans-serif", overflowX: "hidden" }}>
      ...
      {/* Header */}
      <div style={{
        background: "#1a1a1a", padding: "28px 20px 24px",
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 16, overflowX: "auto", paddingBottom: 2 }}>
            {DAYS.map((d, i) => (
              <button key={d.id} className="day-tab" onClick={() => setActiveDay(i)} style={{
                ...
                borderRadius: 6, fontFamily: "'Syne', sans-serif",
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "20px 20px 0" }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
          <div style={{ fontWeight: 800, fontSize: "clamp(26px,6vw,40px)", color: "#1a1a1a", letterSpacing: "-0.03em", lineHeight: 1 }}>
            {day.sublabel}
          </div>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 10, flexWrap: "wrap" }}>
          {day.muscles.map(m => (
            <span key={m} style={{
              ...
              background: day.accent + "22", color: day.accent,
              borderRadius: 20, fontFamily: "'Inconsolata', monospace",
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "16px 20px 60px" }}>
          ...
          return (
            <div key={ei} className="ex-card" style={{
              ...
              <div style={{ padding: "14px 16px 12px", display: "flex", gap: 12, alignItems: "flex-start" }}>
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 8, marginTop: 5, flexWrap: "wrap", alignItems: "center" }}>
                    <span style={{ fontSize: 10, fontFamily: "'Inconsolata', monospace", background: "#f0ede8", color: "#666", padding: "2px 8px", borderRadius: 4 }}>
                      {ex.equipment}
                    </span>
                    ...
                    {validVideos.length > 0 && (
                      <span style={{ fontSize: 9, fontFamily: "'Inconsolata', monospace", background: "#fff5f5", color: "#E8533F", padding: "2px 7px", borderRadius: 4 }}>
                ...
                <div style={{ display: "flex", gap: 5, alignItems: "center", paddingTop: 2, flexShrink: 0 }}>
                  {Array.from({ length: ex.sets }, (_, si) => (
                    <button key={si} className="set-btn" onClick={() => toggleSet(ei, si)} style={{
                      ...
                      fontFamily: "'Inconsolata', monospace", fontWeight: 600, fontSize: 11,
              ...
              <button className="expand-btn" onClick={() => toggleExpand(ei)} style={{
                width: "100%", padding: "7px 16px", background: "#faf8f5",
                borderTop: "1px solid #f0ede8", display: "flex", alignItems: "center", gap: 6,
                color: "#888", fontSize: 11, fontFamily: "'Inconsolata', monospace",
              ...
              {open && (
                <div className="detail-panel" style={{ padding: "16px", borderTop: "1px solid #f0ede8", background: "#fdfcfa" }}>
                  ...
                  <div style={{ marginBottom: 14 }}>
                    <div style={{ fontSize: 10, letterSpacing: "0.12em", color: day.accent, fontFamily: "'Inconsolata', monospace", fontWeight: 600, marginBottom: 7 }}>
                      HOW TO DO IT
                    </div>
                  ...
                  <div>
                    <div style={{ fontSize: 10, letterSpacing: "0.12em", color: "#E8533F", fontFamily: "'Inconsolata', monospace", fontWeight: 600, marginBottom: 7 }}>
                      ⚠ WATCH OUT FOR
                    </div>
                    {ex.gotchas.map((g, gi) => (
                      <div key={gi} className="gotcha-item">
                        <span style={{
                          flexShrink: 0, width: 18, height: 18, background: "#fde8e5", borderRadius: "50%",
                          display: "flex", alignItems: "center", justifyContent: "center",
        ...
        <div style={{
          marginTop: 8, padding: "14px 16px", background: "#fff", borderRadius: 10,
          border: "1px solid #e8e4dd", fontSize: 11.5, color: "#888", lineHeight: 1.7,
